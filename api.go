...
func (rano *Rano) sendRequestWithBinaryFile(method string, params map[string]string, fileParams map[string][]byte) (responseData map[string]interface{}, err error) {
	...
	for key, binaryData := range fileParams {
